"""
Django settings for backstage_44774 project.
...
ROOT_URLCONF = 'backstage_44774.urls'
...
WSGI_APPLICATION = 'backstage_44774.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "backstage_44774 API",
    "DESCRIPTION": "API documentation for backstage_44774 App",
    "VERSION": "v1",
}
